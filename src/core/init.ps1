...
# if ($INIT_WIN -eq 1) { return }
$INIT_WIN = 1
$CURRENT_STEP = 'general'
$WS_ROOT_WIN = (get-item $PSScriptRoot).parent

$Libraries = Get-Childitem -Path "$PSScriptRoot\lib" -Include '*.ps1' -Exclude config_base.ps1, z*.ps1 -File -Recurse -ErrorAction SilentlyContinue
$index=0
